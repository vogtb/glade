/**
 * Drag and Drop system for Flash.
 *
...
import type { FlashElement } from "./element.ts";
 ...
 */
export type CanDropPredicate<T = unknown> = (payload: T, cx: FlashContext) => boolean;
...
export interface DragPayload<T = unknown> {
  ...
  preview?: FlashElement;
  /** Optional offset from cursor for the preview. */
  previewOffset?: Point;
}

/**
 * Active drag state tracked by FlashWindow.
 */
