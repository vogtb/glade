/**
 * Layout engine for Flash - wraps the Taffy WASM module.
 *
...
/**
 * Flash layout engine wrapping Taffy WASM.
 */
export class FlashLayoutEngine {
  ...
  /**
   * Convert Flash Styles to StyleInput for WASM.
   */
