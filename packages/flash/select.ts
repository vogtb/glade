/**
 * CrossElementSelectionManager - Manages text selection across multiple FlashTextElement instances.
 *
...
export class CrossElementSelectionManager {
  ...
  constructor(private window: FlashWindow) {
   ...
   */
  handleKeyDown(event: FlashKeyEvent, window: FlashWindow, cx: FlashContext): EventResult | void {
