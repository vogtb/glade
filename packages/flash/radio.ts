 ...
 */
export class FlashRadioGroupItem extends FlashElement<
 ...
 */
export class FlashRadioGroup extends FlashContainerElement<
...
> {
   ...
   * Children should be FlashRadioGroupItem elements.
   */
 ...
 *   )
 */
export function radioGroup(): FlashRadioGroup {
  return new FlashRadioGroup();
}
 ...
 */
export function radioItem(value: string): FlashRadioGroupItem {
  return new FlashRadioGroupItem(value);
}
