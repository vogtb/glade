/**
 * Inspector/Debug Mode for Flash.
 *
...
export interface ElementDebugInfo {
  ...
  /** Element type name (e.g., "FlashDiv", "FlashTextElement") */
  typeName: string;
...
export class Inspector {
   ...
   */
  private renderBoundsOutlines(scene: FlashScene): void {
    for (const info of this.flatElementList) {
   ...
   */
  private renderSpacingGuides(scene: FlashScene, bounds: Bounds, styles: Partial<Styles>): void {
   ...
   */
  private renderElementIds(_scene: FlashScene): void {
