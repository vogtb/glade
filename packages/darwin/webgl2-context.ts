...
import { lib } from "./gl.ts";
import {
  DarwinWebGLBuffer,
  DarwinWebGLShader,
  DarwinWebGLProgram,
  DarwinWebGLTexture,
  DarwinWebGLFramebuffer,
  DarwinWebGLRenderbuffer,
  DarwinWebGLUniformLocation,
  DarwinWebGLVertexArrayObject,
  DarwinWebGLQuery,
  DarwinWebGLSampler,
  DarwinWebGLSync,
  DarwinWebGLTransformFeedback,
  DarwinWebGLActiveInfo,
  DarwinWebGLShaderPrecisionFormat,
  getHandle,
